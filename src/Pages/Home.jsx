...
const Home = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://backend-1-aue8.onrender.com/api/products/"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://backend-1-aue8.onrender.com/api/products/${editProduct._id}`,
        formData
      );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://backend-1-aue8.onrender.com/api/products/${id.toString()}`
      );
